...
| 자료 | 설명 | 링크 |
| :---- | :---- | :---- |
| **졸업 작품 전체 자료** | 발표 $\\text{PPT}$, 최종 보고서 $\\text{PDF}$, 등 모든 프로젝트 문서 자료 | [Google Drive Link](https://drive.google.com/drive/folders/1b5E_JoIQbwww3fD74A_qyX92ET1qoz7u?usp=sharing) |
...
근데 이거 markdown이 이상한 부분이 있는데 수정해줄래?
